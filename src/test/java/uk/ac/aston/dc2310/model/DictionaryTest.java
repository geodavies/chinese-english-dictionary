...
public class DictionaryTest {
    ...
    @Before
    public void setup() {
        testDictionary = createPopulatedTestDefinitions();
    }
    ...
    public void getSingleDefinitionByPinYin() {
        List<Definition> returnedDefinitions = testDictionary.getDefinitionsByPinYin("xiao1 hua4 mei2");
    ...
    public void getMultipleDefinitionsByPinYin() {
        List<Definition> returnedDefinitions = testDictionary.getDefinitionsByPinYin("yi1 shi4");
    ...
    public void getSingleDefinitionByTraditionalPrefix() {
        List<Definition> returnedDefinitions = testDictionary.getDefinitionsByTraditionalPrefix("杳然");
    ...
    public void getSingleDefinitionByEnglishEquivalent() {
        List<Definition> returnedDefinitions = testDictionary.getDefinitionsByEnglishEquivalent("material for clothing");
    ...
    public void getMultipleDefinitionByEnglishEquivalent() {
        List<Definition> returnedDefinitions = testDictionary.getDefinitionsByEnglishEquivalent("beauty contest");
    ...
    private Dictionary createPopulatedTestDefinitions() {
        ...
        dictionary.addDefinition(new Definition("一世", "一世", "yi1 shi4",
